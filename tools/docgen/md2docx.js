 ...
 * `code` / **bold** / 【確認論点…】【要確認…】 / 〔記入欄〕 を認識する（入れ子も可）。
 *
 * 【確認論点 A-1】は、条文のどこを見てほしいのかを示す目印。黄色の蛍光ペンで
 * 目立たせる。読み手（弁護士）は、この印が付いた箇所だけを追えば、確認すべき
 * 場所を漏れなく回れる。
 * 【要確認…】は、当社側で内容が未確定な箇所を示す旧来の目印（同じ見た目）。
 *
